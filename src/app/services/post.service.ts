...
import { IPaginatedPosts } from '../types/ipaginatedposts';

const BLOG_1_CONTENT = `
...
const MOCK_POSTS: IPost[] = [
  {
    id: '1',
    title: 'From Monolith to Microservices: Lessons I Learned Building My Own Infrastructure',
    tag: 'DevOps & Cloud Dev',
    date: 'Feb 21, 2025',
    img: 'images/monolithic-to-microservices.webp',
    text: 'Tokens, components, docs — the exact process I follow to spin up a coherent design system in 48 hours.',
    featured: true,
    content: BLOG_1_CONTENT
  },
  {
    id: '2',
    title: 'What I Learned Building Multiple REST APIs with Node.js and TypeScript',
    tag: 'Backend & API Dev',
    date: 'Jan 14, 2025',
    img: 'images/rest_api.webp',
    text: 'Contracts, pricing, scope creep, burnout — the things nobody tells you before you go solo.',
    featured: true,
    content: BLOG_2_CONTENT
  },
  {
    id: '3',
    title: 'Frontend Is More Than UI: My Journey with Angular',
    tag: 'Frontend Dev & UI',
    date: 'Dec 3, 2024',
    img: 'images/frontend-ui.webp',
    text: 'No build step, no virtual DOM, no config hell. Just sprinkle some behaviour and ship.',
    featured: true,
...
export class PostService {
  ...
  getPosts(page: number = 1, limit: number = 3, tag: string = 'all'): Observable<IPaginatedPosts> {
    // Simulating API call
  ...
  getFeaturedPosts(): Observable<IPost[]> {
    return of(MOCK_POSTS.filter(p => p.featured));
  }
}
